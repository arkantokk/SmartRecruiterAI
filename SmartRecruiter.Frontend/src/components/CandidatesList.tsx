import {useCandidates} from "../features/candidates/hooks/useCandidates.ts";
    ...
    return (
        <>
            {isError ? (
                ...
                <>
                    {data.map((candidate) => (
                        <div role="status" key={candidate.id}>
                ...
                <div className="text-red-500 font-medium">No candidates</div>
                )}
        </>
    )
}